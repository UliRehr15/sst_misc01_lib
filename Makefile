...
# Template: lib
# Command: /usr/lib/i386-linux-gnu/qt5/bin/qmake -spec linux-g++ CONFIG+=debug -o Makefile sstMisc01Lib.pro
#############################################################################
...
INCPATH       = -I/usr/lib/i386-linux-gnu/qt5/mkspecs/linux-g++ -I. -IHeader -I../sst_str01_lib/Header
AR            = ar cqs
RANLIB        = 
